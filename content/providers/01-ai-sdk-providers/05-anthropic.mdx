...
Anthropic's Haiku, Sonnet, and Opus models support reading image files.
You can pass image files as part of the message content using the `image` type:

Option 1: URL-based image file
  ...
  messages: [
    {
      ...
      content: [
        {
          type: 'text',
          text: 'Please list all the stamps in this passport.',
        },
        {
          type: 'image',
          data: new URL(
...
Option 2: Base64-encoded image document
  ...
  messages: [
    {
      ...
      content: [
        ...
        {
          type: 'image',
          data: fs.readFileSync('./WW2_Spanish_official_passport.jpg'),
        },
      ],
    },
  ],
...
Option 3: File ID from Anthropic Files API
  ...
  messages: [
    {
      ...
      content: [
        ...
        {
          type: 'image',
          data: 'file_011CRwn9QyrS8XYgHMumRJH5',
        },
      ],
    },
  ],
...
Anthropic's Haiku, Sonnet, and Opus models support reading PDF files.
  ...
  messages: [
    {
      ...
      content: [
        ...
        {
          type: 'file',
          data: 'file_011CRwikbpECRLKspRWq1QtR',
          mediaType: 'application/pdf',
        },
      ],
    },
